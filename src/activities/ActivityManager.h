...
class ActivityManager {
 ...
 public:
  ...
  void goToBrowser();
  void goToWebBrowser(std::string url = {});
  void goToMorningBriefing();
  void goToWikipedia(std::string term = {});
  ...
  void goToOpenLibrary(std::string query = {});
  void goToXRayGuide(std::string term = {});
  void goToArticleSync();
  void goToBleRemoteSettings();
